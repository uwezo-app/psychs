        ...
        <SafeAreaView style={styles.container}>
                ...
                <View style={{flexDirection: 'row', marginTop: 15}}>
                    ...
                    <View style={{marginLeft: 20}}>
                        <Title style={[styles.title, {
                            marginTop: 15,
                            marginBottom: 5,
                        }]}>{context.User.FirstName + " " + context.User.LastName}</Title>
                        <Caption style={styles.caption}>@{context.User.FirstName+context.User.LastName}</Caption>
                    </View>
                </View>
            </View>
            ...
            <View style={styles.userInfoSection}>
                <View style={styles.row}>
                    ...
                    <Text style={{color: "#777777", marginLeft: 20}}>{context.User.Profile.Address}</Text>
                </View>

                <View style={styles.row}>
                    <FontAwesome name="phone" color="#777777" size={20}/>
                    <Text style={{color: "#777777", marginLeft: 20}}>{context.User.Profile.Telephone}</Text>
                </View>
                ...
                <View style={styles.row}>
                    ...
                    <Text style={{color: "#777777", marginLeft: 20}}>{context.User.Profile.Description}</Text>
                </View>
